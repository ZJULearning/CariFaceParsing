...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='style', help='chooses how datasets are loaded. [unaligned | aligned | single | star | style | aug]')
        parser.add_argument('--model', type=str, default='style_gan',
